...
AUTHOR = "AZ Studio"
VERSION = "1.0"
HELP_URL = "https://about.azstudio.top/"
FEEDBACK_URL = "https://about.azstudio.top/"
RELEASE_URL = "https://about.azstudio.top/"

def getad(datas):
    url = "https://frp.azstudio.top/ad/music/setting.json"
    try:
        ad = get(url).text
        data = loads(ad)
        msg = data[datas]
...
class SettingInterface(ScrollArea):
    ...
    def __init__(self, parent=None):
        ...
        self.adCard = SwitchSettingCard(
            FIF.CALORIES,
            self.tr('关闭广告'),
            self.tr('还是保留一下吧，我们真的想推广一下qwq 如果你一定要开启的话，得重启程序后才能生效'),
